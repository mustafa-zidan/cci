...
// Write a method to insert Minto N such that M starts at bit j and ends at
...
// 5 bits between j and i. You would not, for example, have j = 3 and
// i = 2, because Mcould not fully fit between bit 3 and bit 2.
//
// EXAMPLE
